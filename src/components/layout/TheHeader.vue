...
<template>
  <header class="bg-white/95 backdrop-blur-lg border-b border-gray-200 shadow-sm sticky top-0 z-40">
      ...
      <div class="flex items-center justify-between h-14 sm:h-16">
        ...
        <div class="flex items-center space-x-2 sm:space-x-4">
          ...
          <router-link to="/dashboard" class="flex items-center space-x-2 sm:space-x-3">
            ...
            <span class="text-lg sm:text-xl font-bold text-slate-700">
        ...
        <div class="flex items-center space-x-2 sm:space-x-4">
          ...
          <button
            ...
            class="p-2 rounded-lg text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 transition-colors relative"
          >
          ...
          <div class="relative" ref="userDropdownRef">
            ...
            <button
              ...
              class="flex items-center space-x-1 sm:space-x-2 p-1.5 sm:p-2 rounded-lg hover:bg-gray-50 transition-colors"
              type="button"
            >
              ...
              <span class="hidden sm:block text-sm font-medium text-slate-700 max-w-32 truncate">{{ userDisplayName }}</span>
            ...
            <div 
              v-show="showUserMenu"
              class="absolute right-0 top-full mt-2 w-48 sm:w-56 bg-white border border-gray-200 rounded-lg shadow-lg z-50 py-1"
            >
              <!-- User Info Header -->
              <div class="px-4 py-3 border-b border-gray-100">
                <p class="text-sm font-medium text-slate-700 truncate">{{ userDisplayName }}</p>
                <p class="text-xs text-slate-500 truncate">{{ currentUser?.email || 'user@example.com' }}</p>
              </div>
